...
bool CClothSimulatorLogic::Initialise()
{
	...
	m_pClothVertexBuffer = g_pApp->GetRenderer()->CreateVertexBuffer(verts, EGpuBufferUsage::DYNAMIC, true);
...
void CClothSimulatorLogic::Render()
{
	...
	g_pApp->GetRenderer()->VRender(m_VertexDeclaration, EPrimitiveType::TRIANGLESTRIP, m_pClothVertexBuffer);
}
